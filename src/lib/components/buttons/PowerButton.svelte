<script lang="ts">
    ...
    onMount(async () => {
        try {
            const response = await fetch( 'https://api.github.com/repos/KevinKeyssx/The-art-of-the-nen' );
...
<button
    ...
    onclick = {() => window.open( "https://github.com/KevinKeyssx/The-art-of-the-nen", "_blank" )}
>
    <span
    ...
    <div class="flex items-center gap-1">
        ...
        <span class="ml-1 text-white">KevinKeyssx</span>
